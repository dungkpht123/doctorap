            	...
            	<div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="service-item bg-light rounded h-100 p-5">
                        <div class="d-inline-flex align-items-center justify-content-center bg-white rounded-circle mb-4" style="width: 65px; height: 65px;">
                            <i class="${ticket.getDoctor().getSpecialty().getIcon() } text-primary fs-4"></i>
                        </div>
                        <p class="mb-4" style="color:black;">Bác sĩ: ${ticket.getDoctor().getAccount().getUserName() }</p>
                        <p class="mb-4" style="color:black;">Ngày khám: ${ticket.date }    ----------------   Trạng thái khám: 
                        <c:if test="${ticket.appointmentStatus=='BOOKED' }"><span class="text-primary">Chờ khám</span></c:if>   
                        </p>
                        <p class="mb-4" style="color:black;">Giờ khám: ${ticket.schedule.schedule }</p>
                        <p class="mb-4" style="color:black;">Triệu chứng: ${ticket.description }</p>
                    </div>
                </div>
