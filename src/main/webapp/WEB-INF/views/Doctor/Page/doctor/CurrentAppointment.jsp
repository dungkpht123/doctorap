...
<body>
    ...
    <main id="main" class="main">
		...
		<section class="section">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Lịch khám hôm nay</h5>
					...
					<table class="table table-hover">
						...
						<tbody>
						<c:forEach items="${current}" var="item">
						<c:if test="${item.appointmentStatus=='BOOKED' }">
							<tr>
								...
								<td>
									<a class="btn btn-success ri-check-fill" href="appointment-success?id=${item.id }"></a>
									<a class="btn btn-danger ri-close-line" href="appointment-canceled?id=${item.id }"></a>
		...
		<section class="section">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title">Danh sách đã khám</h5>
