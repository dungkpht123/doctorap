...
<header id="header" class="header fixed-top d-flex align-items-center">
	<div class="d-flex align-items-center justify-content-between">
		<a href="${contextPath }/admin" class="logo d-flex align-items-center">
			<img src="${contextPath}/resources/img/logo.png" alt=""> <span
		...
		<ul class="d-flex align-items-center">
			...
			<li class="nav-item dropdown pe-3"><a
				...
				data-bs-toggle="dropdown"> <img
					src="${contextPath}${account.avatar != null ? account.avatar : '/resources/img/profile-img.jpg'}"
					alt="Profile" class="rounded-circle"> <c:choose>
			...
			<!-- End Profile Image Icon -->
				...
				<ul
					...
					<li class="dropdown-header"><c:choose>
						...
						</c:choose> <span>Web Designer</span></li>
					<li>
						<hr class="dropdown-divider">
					</li>

					<li><a class="dropdown-item d-flex align-items-center"
						href="${contextPath}/profiletest"> <i class="bi bi-person"></i>
					...
					<li><a class="dropdown-item d-flex align-items-center"
						href="${contextPath}/home"> <i class="bi bi-gear"></i> <span>Go
								To Home Page</span>
					</a></li>
					<li>
						<hr class="dropdown-divider">
