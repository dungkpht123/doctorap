...
#imagePreview {
	...
	border-radius: 10px;
	display: block;
	margin: 0 auto; # notificationContainer { position : fixed;
	bottom: 20px;
	right: 20px;
	z-index: 1000;
	width: 300px;
		...
		<section class="section">
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h2 class="card-title text-center">Tạo bài viết</h2>
							...
							<form:form action="${contextPath}/admin/Post/create" method="post"
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<form:input type="text" class="form-control" path="title"
											id="title" oninput="generateSlug()" />
										<form:errors path="title" cssClass="text-danger" />

									</div>
								</div>
								<div class="row mb-3">
									<label for="url" class="col-sm-2 col-form-label">Đường
										dẫn</label>
									<div class="col-sm-10">
								...
								<div class="row mb-3">
									<label for="shortDescription" class="col-sm-2 col-form-label">Mô
										tả ngắn</label>
									<div class="col-sm-10">
										<form:textarea class="form-control" style="height: 100px"
											path="shortDescription" id="shortDescription"></form:textarea>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<!-- TinyMCE Editor -->
										<form:textarea class="tinymce-editor" path="content"
									...
									<div class="col-sm-10">
										<div class="form-check form-check-inline">
											<form:radiobutton path="status" value="1"
												cssClass="form-check-input" id="gridRadios1" />
											<label class="form-check-label" for="gridRadios1">Hiện
												bài</label>
										</div>
										<div class="form-check form-check-inline">
											<form:radiobutton path="status" value="0"
												cssClass="form-check-input" id="gridRadios2" />
											<label class="form-check-label" for="gridRadios2">Ẩn
												bài</label>
										</div>
									</div>
								</fieldset>
								...
								<div class="row mb-3">
									...
									<div class="col-sm-10">
										<form:select path="specialty.id" class="form-select"
											aria-label="Default select example">
											<option value="" selected>Chọn chuyên khoa</option>
											<form:options items="${specialtyList}" itemLabel="name"
												itemValue="id" />
										</form:select>
									</div>
								</div>
