    ...
    <section class="section">
      <div class="card">
            <div class="card-body">
              ...
              <form:form action="SpecialtyEdit" method="post" modelAttribute="editSpecialty" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <form:select path="icon" class="form-select fa" aria-label="Default select example" required="required">
                      <option class="form-select fa" value="${editSpecialty.icon }" selected>Không thay đổi</option>
